...
const askQuestions = async () => {
    ...
    let formConfig = {formName: null, generatedFields: [], formTitle: null, selector: null, baseName: null};
    ...
    formConfig.baseName = _.kebabCase(answer.formName);
    formConfig.className = _.upperFirst(answer.formName);
